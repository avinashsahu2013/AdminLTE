export const adminLteConf = {
  ...
  sidebarLeftMenu: [
    ...
    {label: 'Dashboard', route: '/', iconClasses: 'fa fa-dashboard', pullRights: [{text: 'New', classes: 'label pull-right bg-green'}]},
    // tslint:disable-next-line: max-line-length
    {label: 'Get Started', route: '/home', iconClasses: 'fa fa-road', pullRights: [{classes: 'label pull-right bg-green'}]},
